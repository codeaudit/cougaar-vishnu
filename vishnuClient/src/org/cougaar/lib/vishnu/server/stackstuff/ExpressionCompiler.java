// $Header: /opt/rep/cougaar/vishnu/vishnuClient/src/org/cougaar/lib/vishnu/server/stackstuff/Attic/ExpressionCompiler.java,v 1.1 2001-08-15 18:21:50 dmontana Exp $
...
public class ExpressionCompiler {
  ...
  private static class ErrorResult extends ResultProducer {
  ...
  private ResultProducer compileOperator (String str, int index,
    ...
    Operator oper = Operator.getOperatorNamed (op);
  ...
  private ResultProducer compileAccessor2 (String access, ResultProducer obj,
    ...
    if (check != null)
      return check;
    Operator oper = Operator.getOperatorNamed ("get");
    ...
    for (int i = 0; i < gps.size(); i++) {
      ...
      if (access.startsWith (gp)) {
        ...
        if (same || (access.charAt (gp.length()) == '.')) {
          Operator oper = Operator.getOperatorNamed ("globget");
          Map object = (Map) objectStructures.get (objType);
