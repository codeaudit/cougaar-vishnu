// $Header: /opt/rep/cougaar/vishnu/vishnuClient/src/org/cougaar/lib/vishnu/server/stackstuff/Attic/SchObject.java,v 1.1 2001-08-15 18:21:56 dmontana Exp $
  ...
  public void addField (String name, String type, Object value,
	...
	try {
	  ...
	  System.out.println ("SchObject.addField - <" + name + ">" +
        ...
        value = v.equals ("true") ? ExecutionStack.TRUE : ExecutionStack.FALSE;
