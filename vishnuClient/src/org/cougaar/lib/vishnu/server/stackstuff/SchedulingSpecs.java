// $Header: /opt/rep/cougaar/vishnu/vishnuClient/src/org/cougaar/lib/vishnu/server/stackstuff/Attic/SchedulingSpecs.java,v 1.1 2001-08-15 18:21:57 dmontana Exp $
...
public class SchedulingSpecs {
  ...
  public int bestTime (Task task, Resource resource,
    ...
    if (i == null)
      return Integer.MIN_VALUE + 1;
    int v = i.intValue();
    return (v > Integer.MIN_VALUE) ? v : (Integer.MIN_VALUE + 1);
  }
  ...
  private class SpecsHandler extends DefaultHandler {
    ...
    public void startElement (String uri, String local, String name,
      ...
      if (name.equals ("LITERAL")) {
        ...
        Operator op = Operator.getOperatorNamed (atts.getValue ("operation"));
        if (op == null)
